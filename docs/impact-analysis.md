...
Always run `./scripts/verify.sh` before review and merge. The result always contains `fullGateRequired: true`. Do not use this advisory graph to skip a required merge check.
